...
public class AttackTableSlashing extends AttackTable {

    private static final int MAX = 150;

    protected AttackTableSlashing() {
        super();
        for (int i = 1; i <= 8; i++) {
            int finalI = i;
        ...
        for (int i = 76; i <= 80; i++) {
            ...
            theTable.get(Armour.NONE).put(i, AttackTableEntry.of(HitPointsDamage.of(7)));
        }
        for (int i = 81; i <= 85; i++) {
            int finalI = i;
        ...
        for (int i = 91; i <= 95; i++) {
            ...
            theTable.get(Armour.NONE).put(i, AttackTableEntry.of(HitPointsDamage.of(11), CriticalHitSeverity.B));
        }
        ...
        for (int i = 106; i <= 110; i++) {
            ...
            theTable.get(Armour.CHAIN).put(i, AttackTableEntry.of(HitPointsDamage.of(11), CriticalHitSeverity.A));
        ...
        for (int i = 111; i <= 115; i++) {
            ...
            theTable.get(Armour.CHAIN).put(i, AttackTableEntry.of(HitPointsDamage.of(12), CriticalHitSeverity.B));
        ...
        for (int i = 116; i <= 120; i++) {
            ...
            theTable.get(Armour.SOFT_LEATHER).put(i, AttackTableEntry.of(HitPointsDamage.of(18), CriticalHitSeverity.D));
            theTable.get(Armour.NONE).put(i, AttackTableEntry.of(HitPointsDamage.of(20), CriticalHitSeverity.D));
        }
        for (int i = 121; i <= 125; i++) {
            int finalI = i;
            theTable.get(Armour.PLATE).put(i, AttackTableEntry.of(HitPointsDamage.of(9), CriticalHitSeverity.A));
            theTable.get(Armour.CHAIN).put(i, AttackTableEntry.of(HitPointsDamage.of(13), CriticalHitSeverity.C));
        ...
        for (int i = 126; i <= 130; i++) {
            ...
            theTable.get(Armour.CHAIN).put(i, AttackTableEntry.of(HitPointsDamage.of(14), CriticalHitSeverity.C));
        ...
        for (int i = 131; i <= 135; i++) {
            ...
            theTable.get(Armour.CHAIN).put(i, AttackTableEntry.of(HitPointsDamage.of(15), CriticalHitSeverity.C));
        ...
        for (int i = 136; i <= 140; i++) {
            int finalI = i;
            theTable.get(Armour.PLATE).put(i, AttackTableEntry.of(HitPointsDamage.of(11), CriticalHitSeverity.C));
            theTable.get(Armour.CHAIN).put(i, AttackTableEntry.of(HitPointsDamage.of(16), CriticalHitSeverity.D));
            theTable.get(Armour.RIGID_LEATHER).put(i, AttackTableEntry.of(HitPointsDamage.of(20), CriticalHitSeverity.D));
        ...
        for (int i = 141; i <= 145; i++) {
            ...
            theTable.get(Armour.CHAIN).put(i, AttackTableEntry.of(HitPointsDamage.of(17), CriticalHitSeverity.D));
            theTable.get(Armour.RIGID_LEATHER).put(i, AttackTableEntry.of(HitPointsDamage.of(21), CriticalHitSeverity.E));
            theTable.get(Armour.SOFT_LEATHER).put(i, AttackTableEntry.of(HitPointsDamage.of(24), CriticalHitSeverity.E));
            theTable.get(Armour.NONE).put(i, AttackTableEntry.of(HitPointsDamage.of(28), CriticalHitSeverity.E));
        }
        for (int i = 146; i <= MAX; i++) {
            int finalI = i;
            theTable.get(Armour.PLATE).put(i, AttackTableEntry.of(HitPointsDamage.of(12), CriticalHitSeverity.E));
            theTable.get(Armour.CHAIN).put(i, AttackTableEntry.of(HitPointsDamage.of(18), CriticalHitSeverity.E));
            theTable.get(Armour.RIGID_LEATHER).put(i, AttackTableEntry.of(HitPointsDamage.of(22), CriticalHitSeverity.E));
    ...
    public AttackTable setUp() {
        return new AttackTableSlashing();
    }
}
